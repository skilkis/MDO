...
# Objective Function:
x.add_system('obj', func, ('2: Objective', r'$f(W_f) = \frac{W_f}{\zero{W_f}}$'))

# Constraints:
x.add_system('fuel', func, ('2: Ineq. Constraint', r'$\frac{W_f}{\rho_f} - V_t \leq 0$'))
x.add_system('wing', func, ('2: Ineq. Constraint', r'$1 - \frac{\left(W_\text{TO}/S\right)}'
...
x.add_input('L', (r'$W_{A\text{-}W}, \eta_\text{max}, h_c,$', r'$M_c, a_c, \rho_c, \mu_c$', r'$N_1, N_2, g, '
                                                                                            r'd_\text{TE}$'))
x.add_input('P', (r'$W_{A\text{-}W}, d_\text{TE}, R_c,$', r'$D_\text{A-W}, \rho_c, V_c, C_T$'))
